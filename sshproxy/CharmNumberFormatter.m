...
@implementation CharmPortFormatter

- (id)init {
    self = [super init];
    if (self) {
        [self setMinimum:[NSDecimalNumber decimalNumberWithString:@"1024"]];
        [self setMaximum:[NSDecimalNumber decimalNumberWithString:@"65534"]];
        [self setNumberStyle:NSNumberFormatterDecimalStyle];
    }
    return self;
}
